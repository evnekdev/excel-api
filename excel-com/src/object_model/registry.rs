...
pub(crate) fn member(id: MemberId, put: bool) -> MemberDescriptor {
    ...
    match (id.as_str(), put) {
        ...
        ("excel.workbook.vbproject", _) => MemberDescriptor {
            id: MemberId::new("excel.workbook.vbproject"),
            name: "VBProject",
            kind: MemberKind::PropertyGet,
        },
        ("excel.vbproject.vbcomponents", _) => MemberDescriptor {
            id: MemberId::new("excel.vbproject.vbcomponents"),
            name: "VBComponents",
            kind: MemberKind::PropertyGet,
        },
        ("excel.vbcomponents.count", _) => MemberDescriptor {
            id: MemberId::new("excel.vbcomponents.count"),
            name: "Count",
            kind: MemberKind::PropertyGet,
        },
        ...
        ("excel.vbcomponent.codemodule", _) => MemberDescriptor {
            id: MemberId::new("excel.vbcomponent.codemodule"),
            name: "CodeModule",
            kind: MemberKind::PropertyGet,
        },
        ("excel.vbacodemodule.countoflines", _) => MemberDescriptor {
            id: MemberId::new("excel.vbacodemodule.countoflines"),
            name: "CountOfLines",
            kind: MemberKind::PropertyGet,
        },
...
fn presentation_member_tail(id: MemberId, put: bool) -> Option<MemberDescriptor> {
    let (name, kind) = match (id.as_str(), put) {
        ...
        ("excel.application.usercontrol", false) => ("UserControl", MemberKind::PropertyGet),
        ("excel.application.usercontrol", true) => ("UserControl", MemberKind::PropertyPut),
        ("excel.application.enableevents", false) => ("EnableEvents", MemberKind::PropertyGet),
        ("excel.application.enableevents", true) => ("EnableEvents", MemberKind::PropertyPut),
        ("excel.windows.count", _) => ("Count", MemberKind::PropertyGet),
