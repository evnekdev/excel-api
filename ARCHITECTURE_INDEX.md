...
| Registration | `REGISTRATION_ARCHITECTURE.md` | M8 manual and M9A generated metadata implemented | M8-M10 |
...
| Macros | `PROC_MACRO_ARCHITECTURE.md` | M9A metadata implemented; thunks deferred | M9-M10 |
