...
| Memory | `MEMORY_OWNERSHIP_ARCHITECTURE.md` | Partial (M2-M3 implemented) | M1-M7 |
| Strings | `STRING_ARCHITECTURE.md` | Partial (borrowed/owned implemented) | M1-M8 |
| Conversion | `TYPE_CONVERSION_ARCHITECTURE.md` | M3 implemented | M2-M5 |
| Arrays/references | `ARRAY_REFERENCE_ARCHITECTURE.md` | Partial (flat owned arrays; borrowed refs) | M2-M8 |
...
| Errors | `ERROR_ARCHITECTURE.md` | Partial (M3 conversion errors implemented) | M2-M13 |
