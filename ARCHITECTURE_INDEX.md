...
| Memory | `MEMORY_OWNERSHIP_ARCHITECTURE.md` | Partial (M2-M5 implemented) | M1-M7 |
| Strings | `STRING_ARCHITECTURE.md` | Partial (stable return storage implemented) | M1-M8 |
| Conversion | `TYPE_CONVERSION_ARCHITECTURE.md` | M3-M5 implemented | M2-M5 |
| Arrays/references | `ARRAY_REFERENCE_ARCHITECTURE.md` | Partial (stable return multis implemented) | M2-M8 |
...
| Errors | `ERROR_ARCHITECTURE.md` | Partial (M3-M5 value/return errors implemented) | M2-M13 |
