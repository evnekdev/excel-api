...
a core 1.0 blocker. Core release blockers are maintained in the
[`M20 readiness audit`](docs/release/core-1.0-readiness-audit.md); optional
integrations are not on that list.
