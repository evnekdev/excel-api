...
| SummaryRow | PROPERTYGET/PROPERTYPUT | XlSummaryRow | declared | 902 | Implemented | Reviewed | Blocked | |
| AutomaticStyles | PROPERTYGET/PROPERTYPUT | bool | declared | 959 | Implemented | Reviewed | Blocked | |
| SummaryColumn | PROPERTYGET/PROPERTYPUT | XlSummaryColumn | declared | 961 | Implemented | Reviewed | Blocked | |

## Methods

| Method | Return | Arguments | Origin | DISPID | Implementation | Docs | Tests | Notes |
|---|---|---:|---|---:|---|---|---|---|
| ShowLevels | AutomationValue | 2 | declared | 960 | Implemented | Reviewed | Blocked | |
