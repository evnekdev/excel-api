...
The apartment-bound Excel formatting object for a Range's fill properties.
...
|---|---|---|---|---:|---|---|---|---|
| Pattern | PROPERTYGET/PROPERTYPUT | AutomationValue | declared | 95 | Implemented | Reviewed | Live Tested | |
| ColorIndex | PROPERTYGET/PROPERTYPUT | AutomationValue | declared | 97 | Implemented | Reviewed | Live Tested | |
| PatternColorIndex | PROPERTYGET/PROPERTYPUT | AutomationValue | declared | 98 | Implemented | Reviewed | Live Tested | |
| Color | PROPERTYGET/PROPERTYPUT | AutomationValue | declared | 99 | Implemented | Reviewed | Live Tested | |
| PatternColor | PROPERTYGET/PROPERTYPUT | AutomationValue | declared | 100 | Implemented | Reviewed | Live Tested | |
| InvertIfNegative | PROPERTYGET/PROPERTYPUT | AutomationValue | declared | 132 | Metadata Only | Reviewed | Not Tested | |
...
| PatternThemeColor | PROPERTYGET/PROPERTYPUT | AutomationValue | declared | 2643 | Metadata Only | Reviewed | Not Tested | |
| PatternTintAndShade | PROPERTYGET/PROPERTYPUT | AutomationValue | declared | 2644 | Metadata Only | Reviewed | Not Tested | |
| Gradient | PROPERTYGET | Object | declared | 2645 | Metadata Only | Reviewed | Not Tested | |
