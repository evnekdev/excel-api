...
|---|---|---|---|---:|---|---|---|---|
| _NewEnum | PROPERTYGET | Unknown | declared | -4 | Implemented | Reviewed | Blocked | |
| _Default | PROPERTYGET | Window | declared | 0 | Metadata Only | Reviewed | Not Tested | |
...
| Item | PROPERTYGET | Window | declared | 170 | Implemented | Reviewed | Blocked | |
| SyncScrollingSideBySide | PROPERTYGET/PROPERTYPUT | bool | declared | 2249 | Metadata Only | Reviewed | Not Tested | |

## Methods

| Method | Return | Arguments | Origin | DISPID | Implementation | Docs | Tests | Notes |
|---|---|---:|---|---:|---|---|---|---|
| Arrange | AutomationValue | 4 | declared | 638 | Metadata Only | Reviewed | Not Tested | |
| CompareSideBySideWith | bool | 1 | declared | 2246 | Metadata Only | Reviewed | Not Tested | |
| BreakSideBySide | bool | 0 | declared | 2248 | Metadata Only | Reviewed | Not Tested | |
| ResetPositionsSideBySide | Unknown | 0 | declared | 2250 | Metadata Only | Reviewed | Not Tested | |
