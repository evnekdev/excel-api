...
The typed collection of contiguous ranges produced by a multi-area Range.
...
| `_Default` | `excel.range` | Metadata Only |
| `Item` | `excel.range` | Implemented |
...
| _Default | PROPERTYGET | Range | declared | 0 | Metadata Only | Reviewed | Not Tested | |
...
| Item | PROPERTYGET | Range | declared | 170 | Implemented | Reviewed | Live Tested | |
