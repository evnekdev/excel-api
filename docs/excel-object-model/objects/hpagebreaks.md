...
| Type flags | 4096 |
| Crate type | `excel_com::HPageBreaks` |
...
| _Default | PROPERTYGET | HPageBreak | declared | 0 | Metadata Only | Reviewed | Not Tested | |
...
| Item | PROPERTYGET | HPageBreak | declared | 170 | Implemented | Reviewed | Blocked | |

## Methods

| Method | Return | Arguments | Origin | DISPID | Implementation | Docs | Tests | Notes |
|---|---|---:|---|---:|---|---|---|---|
| Add | HPageBreak | 1 | declared | 181 | Implemented | Reviewed | Blocked | |
