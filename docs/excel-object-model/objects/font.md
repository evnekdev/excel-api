...
The apartment-bound Excel formatting object for a Range's font properties.
...
|---|---|---|---|---:|---|---|---|---|
| Bold | PROPERTYGET/PROPERTYPUT | AutomationValue | declared | 96 | Implemented | Reviewed | Live Tested | |
...
| Name | PROPERTYGET/PROPERTYPUT | AutomationValue | declared | 110 | Implemented | Reviewed | Live Tested | |
